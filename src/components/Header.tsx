...
const Header = () => {
    return (
        <>
            <div className='main-div grid tablet:grid-cols-2 grid-cols-1 tablet:mx-28 mobile:mx-5 tablet:mt-44 mobile:mt-20  m-auto '>
                <div className="left-side mt-16">
                    ...
                    <button className='bg-gray-950 text-white font-semibold tablet:justify-evenly justify-center flex  py-2 mt-8 w-72 tablet:w-36 px-4'><AiOutlineShoppingCart className='mt-1 mr-3 tablet:mt-3'/> <Link href="/allproducts">Start Shopping</Link></button>
                </div>
